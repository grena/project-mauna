define([
    ...
    // console.log(angular.element(document).context.documentElement.getAttribute('data-csrf-token'));
    app.constant("CSRF_TOKEN", angular.element(document).context.documentElement.getAttribute('data-csrf-token'));
